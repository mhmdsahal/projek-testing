var size = 0;
var placement = 'point';
function categories_JumlahMurid_1(feature, value, size, resolution, labelText,
                       labelFont, labelFill) {
                switch(value.toString()) {case '10520':
...
var style_JumlahMurid_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Jmlh_Murid");
    var labelText = "";
    size = 0;
...
var style = categories_JumlahMurid_1(feature, value, size, resolution, labelText,
                          labelFont, labelFill);
