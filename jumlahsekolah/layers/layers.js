var wms_layers = [];
    ...
    attributions: [new ol.Attribution({html: '<a href="https://www.google.at/permissions/geoguidelines/attr-guide.html">Map data ©2015 Google</a>'})],
        ...
        });var format_JumlahSekolah_1 = new ol.format.GeoJSON();
var features_JumlahSekolah_1 = format_JumlahSekolah_1.readFeatures(json_JumlahSekolah_1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_JumlahSekolah_1 = new ol.source.Vector({
    attributions: [new ol.Attribution({html: '<a href=""></a>'})],
});
jsonSource_JumlahSekolah_1.addFeatures(features_JumlahSekolah_1);var lyr_JumlahSekolah_1 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_JumlahSekolah_1, 
                style: style_JumlahSekolah_1,
    title: 'JumlahSekolah<br />\
    <img src="styles/legend/JumlahSekolah_1_0.png" /> 23<br />\
    <img src="styles/legend/JumlahSekolah_1_1.png" /> 32<br />\
    <img src="styles/legend/JumlahSekolah_1_2.png" /> 46<br />\
    <img src="styles/legend/JumlahSekolah_1_3.png" /> 78<br />\
    <img src="styles/legend/JumlahSekolah_1_4.png" /> 83<br />\
    <img src="styles/legend/JumlahSekolah_1_5.png" /> 85<br />\
    <img src="styles/legend/JumlahSekolah_1_6.png" /> 94<br />\
    <img src="styles/legend/JumlahSekolah_1_7.png" /> <br />'
...
lyr_GoogleRoad_0.setVisible(true);lyr_JumlahSekolah_1.setVisible(true);lyr_smpakreditasi_2.setVisible(true);lyr_smaakreditasi_3.setVisible(true);lyr_smkakreditasi_4.setVisible(true);
var layersList = [lyr_GoogleRoad_0,lyr_JumlahSekolah_1,lyr_smpakreditasi_2,lyr_smaakreditasi_3,lyr_smkakreditasi_4];
lyr_JumlahSekolah_1.set('fieldAliases', {'id': 'id', 'Nama_Kec': 'Nama_Kec', 'Sklh_Akrdt': 'Sklh_Akrdt', 'Jmlh_Sklh': 'Jmlh_Sklh', 'Jmlh_Murid': 'Jmlh_Murid', });
...
lyr_JumlahSekolah_1.set('fieldImages', {'id': 'TextEdit', 'Nama_Kec': 'TextEdit', 'Sklh_Akrdt': 'TextEdit', 'Jmlh_Sklh': 'TextEdit', 'Jmlh_Murid': 'TextEdit', });
...
lyr_JumlahSekolah_1.set('fieldLabels', {'id': 'inline label', 'Nama_Kec': 'inline label', 'Sklh_Akrdt': 'no label', 'Jmlh_Sklh': 'inline label', 'Jmlh_Murid': 'no label', });
